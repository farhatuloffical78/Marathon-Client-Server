...
const Loginpage = () => {
    ...
    const { loginUser, googleSignIn, setCurrentUser } = useContext(AuthenticationContext);
    ...
    Forgot Password?
                    ...
                    {error && (
                        <div className="mt-4 text-red-500 text-sm">
                            <p>{error === 'auth/user-not-found' ? 'User not found. Please register.' : 'Invalid credentials, please try again.'}</p>
                        </div>
                    )}
                    ...
                    <p className="text-center text-sm text-gray-600 mt-6">
                        ...
                        <Link to="/reg" className="text-blue-500 hover:underline font-medium">Register</Link>
                    </p>
                </div>
            </div>
            <Footer />
