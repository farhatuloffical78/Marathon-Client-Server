...
const Footer = () => {
  ...
  <img src={logo} alt="RaceFlow Logo" className="w-16 h-16 mb-2 md:mb-0 md:mr-3" />
  <a className="text-white font-extrabold text-2xl md:text-3xl hover:text-red-500 transition duration-300">
    Race<span className="text-red-500">Flow</span>
  </a>
</div>
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-300 text-sm mb-4">Subscribe to our newsletter for the latest race updates and news.</p>
 ...
 <div className="text-center">
        ...
        <div className="mt-16 border-t border-gray-700 pt-6 text-center">
          <p className="text-sm text-gray-400">
            &copy; 2024 RaceFlow. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
