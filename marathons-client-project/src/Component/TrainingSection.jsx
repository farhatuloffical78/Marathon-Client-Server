...
const TrainingSection = () => {
  return (
    <section className='bg-gray-100'>
        <div className="bg-gray-100 w-full md:w-10/12 mx-auto flex flex-col md:flex-row items-center p-8">
      {/* Image Section */}
      ...
      <div className="w-full md:w-1/2 text-center md:text-left mt-6 md:mt-0 md:pl-8">
        ...
        {/* Button */}
        <button className="mt-6 bg-orange-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-orange-600">
          Learn More
        </button>
      </div>
    </div>
